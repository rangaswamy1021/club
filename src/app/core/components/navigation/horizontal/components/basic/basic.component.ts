...
import { FuseUtilsService } from '@shared/utils.service';
import { Subject, takeUntil } from 'rxjs';
import { HorizontalNavigationComponent } from '../../horizontal.component';

@Component({
    selector       : 'sl-horizontal-navigation-basic-item',
...
export class HorizontalNavigationBasicItemComponent implements OnInit, OnDestroy
{
    ...
    private _fuseHorizontalNavigationComponent: HorizontalNavigationComponent;
    ...
    constructor(
        ...
        private _fuseNavigationService: SLNavigationService,
